...
ticker = st.sidebar.text_input('Crypto Symbol', 'BTC')
...
st.sidebar.header('📈 Real-Time Crypto Prices')
stock_symbols = ['BTC', 'ETH', 'SOL', 'BNB']
for symbol in stock_symbols:
    real_time_data = fetch_stock_data(symbol+'-USD', '1d', '1m')
